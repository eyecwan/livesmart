...
},{"../core-js/get-iterator":1,"../core-js/is-iterable":2}],4:[function(require,module,exports){
/*!
...
},{"./_global":21,"./_hide":23,"./_iterators":31,"./_wks":52,"./es6.array.iterator":56}],59:[function(require,module,exports){
/*!
...
},{"_process":60}],64:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        followTopic: function followTopic(topic) {
            ...
            this.$http.get('/topic/' + topic.id + '/follow').then(function (response) {
                console.log(response);
            }, function (response) {
                console.log(response);
                _this.topic.followed = false;
            });
        },
        unfollowTopic: function unfollowTopic(topic) {
            var _this2 = this;

            this.$http.get('/topic/' + topic.id + '/unfollow').then(function (response) {
                console.log(response);
            }, function (response) {
                console.log(response);
                _this2.topic.followed = true;
            });
        },
        toggleFollowTopic: function toggleFollowTopic(topic) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-4bac5ccb", module.exports)
  } else {
    hotAPI.update("_v-4bac5ccb", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":63,"vue-hot-reload-api":61}],65:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        sortByLikes: function sortByLikes() {
        ...
        orderByWords: function orderByWords(a, b) {
            return a.name.length - b.name.length;
        },
        toggleLike: function toggleLike(input) {
            if (input.isLiked) {
                this.unlike(input);
            } else {
                this.like(input);
        ...
        unlike: function unlike(input) {
            input.like_counter.count--;
            input.isLiked = !input.isLiked;
            this.storeUnlike(input);
        },
        storeLike: function storeLike(input) {
            // GET /someUrl
            this.$http.get('/input/' + input.id + '/like').then(function (response) {
                console.log(response);
                // success callback
            }, function (response) {
                // error callback
        ...
        storeUnlike: function storeUnlike(input) {
            this.$http.get('/input/' + input.id + '/unlike').then(function (response) {
                console.log(response);
            }, function (response) {
                input.isLiked = true;
            });
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3bf3f257", module.exports)
  } else {
    hotAPI.update("_v-3bf3f257", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":63,"vue-hot-reload-api":61}],66:[function(require,module,exports){
'use strict';
    ...
    methods: {
        addInput: function addInput() {
            if (this.new_input.trim().length > 0) {
                ...
                var _detectTag = this.detectTag();

                var _detectTag2 = (0, _slicedToArray3.default)(_detectTag, 2);

                var matchedTags = _detectTag2[0];
                var type = _detectTag2[1];

                this.storeInput(length - 1, matchedTags, type);
                this.new_input = '';
            }
        },
        newInputContains: function newInputContains(element) {
            return this.new_input.indexOf(element) > -1;
        },
        detectTag: function detectTag() {
            var wantedTags = ['方太', '西门子', '博世', '伊莱克斯', '小米'];
        ...
        storeInput: function storeInput(removeIndex, matchedTags, friendly) {
            var _this = this;
            ...
            this.$http.post('/topic/' + this.topic.id + '/input/', {
                ...
                console.log(response);
                _this.topic.inputs.splice(removeIndex, 1);
                _this.topic.inputs.push(response.json());
                if (matchedTags.length > 0) {
                    _this.storeTags(response.json(), matchedTags.join());
                }
            }, function (response) {});
        },
        deleteTopic: function deleteTopic(input) {
            this.topic.inputs.$remove(input);
            this.destroyInput(input);
        },
        destroyInput: function destroyInput(input) {
            this.$http.delete('/input/' + input.id).then(function (response) {
                console.log(response);
            }, function (response) {});
        },
        storeTags: function storeTags(input, tags) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-5ecb7896", module.exports)
  } else {
    hotAPI.update("_v-5ecb7896", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"babel-runtime/helpers/slicedToArray":3,"vue":63,"vue-hot-reload-api":61}],67:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7c55c932", module.exports)
  } else {
    hotAPI.update("_v-7c55c932", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":63,"vue-hot-reload-api":61}],68:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        toggleFollowUser: function toggleFollowUser() {
            ...
            this.$http.get('/user/' + this.user.id + '/' + action).then(function (response) {
                console.log(response);
            }, function (response) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-64a81d64", module.exports)
  } else {
    hotAPI.update("_v-64a81d64", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":63,"vue-hot-reload-api":61}],69:[function(require,module,exports){
'use strict';
...
var _FollowTopic = require('./components/FollowTopic.vue');

var _FollowTopic2 = _interopRequireDefault(_FollowTopic);

var _LeaveInput = require('./components/LeaveInput.vue');

var _LeaveInput2 = _interopRequireDefault(_LeaveInput);

var _User = require('./components/User.vue');

var _User2 = _interopRequireDefault(_User);

var _Topics = require('./components/Topics.vue');
...
new Vue({
    ...
    components: {
        ...
        Follow: _FollowTopic2.default,
        LeaveInput: _LeaveInput2.default,
        User: _User2.default,
...
},{"./components/FollowTopic.vue":64,"./components/Input.vue":65,"./components/LeaveInput.vue":66,"./components/Topics.vue":67,"./components/User.vue":68,"bootstrap-sass":4,"jquery":59,"vue":63,"vue-resource":62}]},{},[69]);
